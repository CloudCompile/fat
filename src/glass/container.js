...
export class Container {
  ...
  static recapture() {
    ...
    Container.isCapturing = true
    Container.waitingForSnapshot = Container.instances.filter(i => !i.webglInitialized)
    const first = Container.instances[0]
    if (first) first.capturePageSnapshot()
  }
  ...
  `
    ...
    void main() {
      ...
      vec2 center = vec2(0.5, 0.5);
        ...
        vec3 topTint = vec3(0.30, 0.34, 0.58);
        vec3 bottomTint = vec3(0.05, 0.06, 0.13);
